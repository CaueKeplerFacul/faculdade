...
int main() {
    char estado1, estado2, tipoComparacao;
    ...
    printf("M - Maior Carta Vence - Densidade demografica será quanto menor, mais forte ela sera.\n");
    printf("N - Menor Carta Vence - Densidade demografica será quanto menor, mais forte ela sera.\n");
